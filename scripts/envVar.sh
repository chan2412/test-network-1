...
export PEER0_ORG1_CA=${PWD}/organizations/peerOrganizations/hospital1.example.com/peers/peer0.hospital1.example.com/tls/ca.crt
export PEER0_ORG2_CA=${PWD}/organizations/peerOrganizations/hospital2.example.com/peers/peer0.hospital2.example.com/tls/ca.crt
export PEER0_ORG3_CA=${PWD}/organizations/peerOrganizations/laboratory.example.com/peers/peer0.laboratory.example.com/tls/ca.crt
...
setGlobalsCLI() {
  ...
  if [ $USING_ORG -eq 1 ]; then
    ...
    export CORE_PEER_ADDRESS=peer0.laboratory.example.com:10051
  else
    errorln "ORG Unknown"
  fi
}
